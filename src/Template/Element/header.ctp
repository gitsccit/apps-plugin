...
<header>
    ...
    <form id="global-search" action="<?= $this->Url->build(['controller' => 'Search','action' => 'query','plugin' => null]) ?>" method="GET" onsubmit="return app_global_search_handler(event)">
    ...
    <nav>
        <ul id="header-actions" class="navmenu">
            ...
            <li><a href="<?= $this->Url->build('/users/view') ?>"><span id="user-profile" style="background-image:url(<?= $this->Url->build(['controller' => 'users','action' => 'profileimage','plugin' => null,$userldapid]) ?>)"></span></a>
                <?php if($userldapid): ?>
                <ul>
                    <li><?= $this->Html->link("Profile ".$username,['controller' => 'users','action' => 'view','plugin' => null]) ?></li>
                    <li><?= $this->Html->link("Employee Directory",['controller' => 'users','plugin' => null]) ?></li>
                    <li><hr></li>
                    <li><?= $this->Html->link("<span class='icon-logout'></span>Logout",['controller' => 'session','action' => 'end','plugin' => null],['escape' => false]) ?></li>
                </ul>
                <?php endif; ?>
            </li>
        </ul>
