...
class FilesStoresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'FK_files_stores_apps.files' => ['type' => 'index', 'columns' => ['file_id'], 'length' => []],
            'FK_files_stores_apps.stores' => ['type' => 'index', 'columns' => ['store_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['file_id', 'store_id'], 'length' => []],
            'FK_files_stores_file_id' => ['type' => 'foreign', 'columns' => ['file_id'], 'references' => ['files', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'FK_files_stores_store_id' => ['type' => 'foreign', 'columns' => ['store_id'], 'references' => ['stores', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
